### Coloc fine-mapping script generated by Doris Wong in the Miller Lab @ UVA
### Requires pre-formatted CAC 1000G GWAS meta-analysis (European ancestry) and STARNET mammary artery cis-eQTL summary statistics files
### Please refer to methods in manuscript Kavousi M et al. for more details 
